...
.checkout-orders .inputBox input[type="text"],
.checkout-orders .inputBox input[type="number"],
.checkout-orders .inputBox input[type="email"],
.checkout-orders .inputBox select {
    width: 100%;
    padding: 10px;
    margin-bottom: 10px;
