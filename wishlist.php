...
if(isset($_POST['add_to_cart'])){
   ...
   $check_cart_numbers = $conn->prepare("SELECT * FROM `wishlist` WHERE name = ? AND user_id = ?");
   ...
   if($check_cart_numbers->rowCount() > 0){
      ...
      $insert_cart = $conn->prepare("INSERT INTO `wishlist`(user_id, pid, name, price, quantity, image) VALUES(?,?,?,?,?,?)");
